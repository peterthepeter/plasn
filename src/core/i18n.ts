...
const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    fieldShowTextPrefix: "Show prefix in text",
    fieldShowLeadingZeros: "Show leading zeros in text",
    fieldDirection: "Numbering direction",
    fieldStartPosition: "Start position",
    fieldPreset: "Label preset",
    fieldCalibrationProfile: "Profile",
    fieldShowBorders: "Show debug borders",
    ...
    fieldPitchX: "Pitch adjust X (mm)",
    fieldPitchY: "Pitch adjust Y (mm)",
    fieldProfileName: "Name",
    optionColumn: "Column-wise",
    optionRow: "Row-wise",
  ...
  de: {
    ...
    fieldShowTextPrefix: "Präfix im Text",
    fieldShowLeadingZeros: "Führende Nullen im Text",
    fieldDirection: "Nummerierungsrichtung",
    fieldStartPosition: "Startposition",
    fieldPreset: "Etikettenformat",
    fieldCalibrationProfile: "Profil",
    fieldShowBorders: "Debug-Rahmen anzeigen",
    ...
    fieldOffsetX: "Offset X (mm)",
    fieldOffsetY: "Offset Y (mm)",
    fieldPitchX: "Pitch-Korrektur X (mm)",
    fieldPitchY: "Pitch-Korrektur Y (mm)",
    fieldProfileName: "Name",
    optionColumn: "Spaltenweise",
    optionRow: "Zeilenweise",
